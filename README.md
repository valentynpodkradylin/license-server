...
Для передачи клиенту используйте готовую папку [`client-interceptor`](client-interceptor).
Она без секретов перенаправляет старый домен плагина на публичный Vercel-сервер.
